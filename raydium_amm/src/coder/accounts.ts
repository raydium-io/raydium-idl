...
const AMM_INFO_LAYOUT: any = B.struct([B.u64("status"),B.u64("nonce"),B.u64("orderNum"),B.u64("depth"),B.u64("coinDecimals"),B.u64("pcDecimals"),B.u64("state"),B.u64("resetFlag"),B.u64("minSize"),B.u64("volMaxCutRatio"),B.u64("amountWave"),B.u64("coinLotSize"),B.u64("pcLotSize"),B.u64("minPriceMultiplier"),B.u64("maxPriceMultiplier"),B.u64("sysDecimalValue"),B.struct([B.u64("minSeparateNumerator"),B.u64("minSeparateDenominator"),B.u64("tradeFeeNumerator"),B.u64("tradeFeeDenominator"),B.u64("pnlNumerator"),B.u64("pnlDenominator"),B.u64("swapFeeNumerator"),B.u64("swapFeeDenominator"),], "fees"),B.struct([B.u64("needTakePnlCoin"),B.u64("needTakePnlPc"),B.u64("totalPnlPc"),B.u64("totalPnlCoin"),B.u64("poolOpenTime"),B.u64("punishPcAmount"),B.u64("punishCoinAmount"),B.u64("orderbookToInitTime"),B.u128("swapCoinInAmount"),B.u128("swapPcOutAmount"),B.u64("swapTakePcFee"),B.u128("swapPcInAmount"),B.u128("swapCoinOutAmount"),B.u64("swapTakeCoinFee"),], "outPut"),B.publicKey("tokenCoin"),B.publicKey("tokenPc"),B.publicKey("coinMint"),B.publicKey("pcMint"),B.publicKey("lpMint"),B.publicKey("openOrders"),B.publicKey("market"),B.publicKey("serumDex"),B.publicKey("targetOrders"),B.publicKey("withdrawQueue"),B.publicKey("tokenTempLp"),B.publicKey("ammOwner"),B.u64("lpAmount"),B.u64("clientOrderId"),B.seq(B.u64(), 2, "padding"),]);
